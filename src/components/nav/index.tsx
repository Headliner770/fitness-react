...
const NavBar = () => {
  ...
  return (
    <nav className="relative bg-red-400 h-[88px]">
      <div
        className={`${navbarBg} ${
          isTopPage ? "py-6" : "py-4"
            ...
            {isAboveMediaScrin ? (
              <div className="flex-between w-full">
                ...
                <div className="flex-between gap-8">
                  <button className="rounded-md bg-orange-500 px-10 py-2 cursor-pointer hover:bg-yellow-500 hover:text-white animate">
                    Sign in
                  </button>
              ...
              <>
                <button className="rounded-full bg-yellow-400 p-2 animate">
                  <Bars3Icon
                    className="h-6 w-6 text-white animate"
